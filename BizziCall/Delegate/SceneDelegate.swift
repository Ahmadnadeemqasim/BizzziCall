...
//  BizziCall
//
//  Created by Ahmad Qasim on 6/8/24.
//
    ...
    func getInitialViewController() -> UIViewController {
        if isUserLoggedIn() {
            ...
            if isPermissionsGranted() {
                ...
                let storyboard = UIStoryboard(name: "Authentication", bundle: nil)
                let initialViewController = storyboard.instantiateViewController(withIdentifier: "PermissionVC") as! PermissionVC
                return initialViewController
            }
        }
    }
